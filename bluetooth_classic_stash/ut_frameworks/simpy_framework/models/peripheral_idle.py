...
import random 
class peripheral_idle(sim_models):
    ...
    def schedule_tx_handler(self):
        ...
        return f"activity_monitor schedule_tx peripheral_idle {next_slave_slot_tsf} 128"
    ...
    def schedule_rx_handler(self):
        ...
        return f"activity_monitor schedule_rx peripheral_idle {next_master_slot_tsf} 128"
    
    def rx_complete_handler(self, args):
        peer_response = random.choices(["ACK", "NACK"], [10,90])
    ...
    def schedule_sleep_handler(self):
        ...
        return f"activity_monitor lpwss_schedule_sleep peripheral_idle {wakeup_tsf}"

    def lpwss_sleep_start_handler(self, args):
        return f"activity_monitor hss_schedule_sleep peripheral_idle {self.wakeup_tsf}"
