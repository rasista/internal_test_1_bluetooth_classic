...
if __name__ == "__main__":
    ...
    if args.s:
        sbc_frame.sub_bands
    if args.b:
        sbc_frame.block_size = args.b
    if args.bp:
        sbc_frame.bitpool = args.bp
    sbc_frame.get_frame_length()
    sbc_frame.get_audio_duration()
    print(vars(sbc_frame))