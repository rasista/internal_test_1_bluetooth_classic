...
export CHIP_NAME="sixg300xilpwh74000fpga"  
...
cd ../../../gsdk/platform/radio/rail_lib/
make librail_sixg300xilpwh74000fpga_gcc_debug RAIL_LIB_DEV=1 -j 

# Step 3: Navigate to lite_controller directory
cd ../../../protocol/bluetooth_classic/src/lc/llc/ut/lite_controller/


# Step 5: Run slc configuration
slc configuration --sdk ../../../../../../../


# Step 6: Generate project with slc
sled slc generate --export-destination build/ --generator-timeout 360 --project-file lite_controller.slcp --toolchain toolchain_gcc --with emdk1001_lpwh74000_fpga,rail_lib_singleprotocol_debug
